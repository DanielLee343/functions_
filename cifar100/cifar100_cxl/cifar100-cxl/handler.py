...
def do_serve(net, net_name, portion):
    cifar100_test_loader = get_test_dataloader(
        settings.CIFAR100_TRAIN_MEAN,
        settings.CIFAR100_TRAIN_STD,
    ...
    samples_to_serve = 62.5 * portion # portion: [1:10], samples_to_serve: [62.5:625]
...
def handle(req):
    ...
    if train_or_serve == 'train':
        ...
        time_used = do_serve(net, net_name, portion)
