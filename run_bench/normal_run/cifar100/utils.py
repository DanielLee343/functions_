...
def get_training_dataloader(mean, std, batch_size=16, num_workers=2, shuffle=True):
    ...
    cifar100_training = torchvision.datasets.CIFAR100(root=SCRIPT_DIR+'/data', train=True, download=True, transform=transform_train)
...
def get_test_dataloader(mean, std, batch_size=16, num_workers=2, shuffle=True):
    ...
    cifar100_test = torchvision.datasets.CIFAR100(root=SCRIPT_DIR+'/data', train=False, download=True, transform=transform_test)
